...
class SecondViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var items: [String] = ["One-Dimensional Motion", "Two-Dimensional Motion", "Forces and Newton", "Work and Energy"]
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        let destViewController = segue.destinationViewController as ThirdViewController
